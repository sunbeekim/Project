...
import { Route, Routes, Link, useLocation, useNavigate, BrowserRouter as Router } from 'react-router-dom';
import { Navbar, Nav, Container, Button } from 'react-bootstrap';
import 'bootstrap/dist/css/bootstrap.min.css';
import './App.css';
import Home from './page/Home.js';
import Board from './page/Board.js';
import MovieSearch from './page/MovieSearch.js';
...
import MovieRank from './page/MovieRank.js';
      ...
      <div className="d-flex flex-column min-vh-100">
          ...
          <Container>
            ...
            <Navbar.Collapse id="navbarNav">
              <Nav className="ms-auto align-items-center">
                ...
                <Nav.Link as={Link} to="/movie-rank" className="mx-2 nav-link">
                  MovieRank
                </Nav.Link>
        ...
        <main className="flex-grow-1 container my-5 pt-4">
          <Routes>
            ...
            <Route path="/movie-rank" element={<MovieRank />} />
            <Route path="/movie-booking" element={<MovieSearch />} />
        ...
        <Container>
          <div className="row align-items-center">
            ...
            <div className="col-lg-4 text-center mb-2 mb-lg-0">
              <a 
                href="https://github.com/sunbeekim/Project" 
                target="_blank" 
